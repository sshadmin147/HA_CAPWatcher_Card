 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Be, defineProperty: We, getOwnPropertyDescriptor: Fe, getOwnPropertyNames: Ve, getOwnPropertySymbols: Ze, getPrototypeOf: qe } = Object, m = globalThis, ye = m.trustedTypes, Ge = ye ? ye.emptyScript : "", ee = m.reactiveElementPolyfillSupport, M = (t, e) => t, V = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? Ge : null;
      break;
...
C.elementStyles = [], C.shadowRootOptions = { mode: "open" }, C[M("elementProperties")] = /* @__PURE__ */ new Map(), C[M("finalized")] = /* @__PURE__ */ new Map(), ee == null || ee({ ReactiveElement: C }), (m.reactiveElementVersions ?? (m.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const T = globalThis, ve = (t) => t, Z = T.trustedTypes, me = Z ? Z.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, Le = "$lit$", v = `lit$${Math.random().toFixed(9).slice(2)}$`, Ne = "?" + v, Je = `<${Ne}>`, A = document, H = () => A.createComment(""), z = (t) => t === null || typeof t != "object" && typeof t != "function", ae = Array.isArray, Ke = (t) => ae(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", te = `[ 	
\f\r]`, U = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, $e = /-->/g, be = />/g, b = RegExp(`>|${te}(?:([^\\s"'>=/]+)(${te}*=${te}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), xe = /'/g, we = /"/g, Ue = /^(?:script|style|textarea|title)$/i, Me = (t) => (e, ...s) => ({ _$litType$: t, strings: e, values: s }), c = Me(1), Ae = Me(2), P = Symbol.for("lit-noChange"), h = Symbol.for("lit-nothing"), Se = /* @__PURE__ */ new WeakMap(), x = A.createTreeWalker(A, 129);
function Te(t, e) {
...
const Ye = (t, e) => {
  ...
  for (let l = 0; l < s; l++) {
    const a = t[l];
    let p, u, d = -1, y = 0;
    for (; y < a.length && (o.lastIndex = y, u = o.exec(a), u !== null); ) y = o.lastIndex, o === U ? u[1] === "!--" ? o = $e : u[1] !== void 0 ? o = be : u[2] !== void 0 ? (Ue.test(u[2]) && (i = RegExp("</" + u[2], "g")), o = b) : u[3] !== void 0 && (o = b) : o === b ? u[0] === ">" ? (o = i ?? U, d = -1) : u[1] === void 0 ? d = -2 : (d = o.lastIndex - u[2].length, p = u[1], o = u[3] === void 0 ? b : u[3] === '"' ? we : xe) : o === we || o === xe ? o = b : o === $e || o === be ? o = U : (o = b, i = void 0);
    const _ = o === b && t[l + 1].startsWith("/>") ? " " : "";
    n += o === U ? a + Je : d >= 0 ? (r.push(p), a.slice(0, d) + Le + a.slice(d) + v + _) : a + v + (d === -2 ? l : _);
  }
  return [Te(t, n + (t[s] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), r];
};
class R {
...
class I {
  ...
  $(e) {
    var n;
    const { values: s, _$litType$: r } = e, i = typeof r == "number" ? this._$AC(e) : (r.el === void 0 && (r.el = R.createElement(Te(r.h, r.h[0]), this.options)), r);
...
se == null || se(R, I), (T.litHtmlVersions ?? (T.litHtmlVersions = [])).push("3.3.3");
const rt = (t, e, s) => {
...
var vt = Object.defineProperty, mt = Object.getOwnPropertyDescriptor, Q = (t, e, s, r) => {
  for (var i = r > 1 ? void 0 : r ? mt(e, s) : e, n = t.length - 1, o; n >= 0; n--)
    (o = t[n]) && (i = (r ? o(e, s, i) : o(i)) || i);
  return r && i && vt(e, s, i), i;
};
const $t = "M 87,8 L 111,20 L 117,60 L 126,54 L 137,76 L 163,74 L 143,110 L 121,148 L 114,146 L 116,138 L 117,118 L 100,106 L 104,90 L 111,56 L 91,30 Z", bt = "M 87,130 L 96,146 L 104,140 L 103,150 L 100,168 L 90,196 L 65,222 L 48,244 L 31,252 L 25,242 L 22,228 L 25,214 L 34,198 L 55,188 L 68,170 L 73,156 L 79,144 Z", xt = "M 28,258 L 34,264 L 30,270 L 22,268 L 20,262 Z";
function Pe(t, e) {
  const s = (e - 166) * 13, r = (Math.abs(t) - 34) * 20;
  return [Math.round(s * 10) / 10, Math.round(r * 10) / 10];
}
function wt(t) {
  const e = t.match(/^(-?\d+\.?\d*),(-?\d+\.?\d*)\s+(\d+\.?\d*)$/);
  if (e) {
    const r = parseFloat(e[1]), i = parseFloat(e[2]), n = parseFloat(e[3]), [o, l] = Pe(r, i), a = n / 111 * 20;
    return { type: "circle", circle: [o, l, Math.max(a, 4)] };
  }
  ...
  render() {
    ...
    return c`
      <div class="detail">
        ...
        ${t.description ? c`
          <div class="description">${this._clean(t.description)}</div>
        ` : ""}
...
var Et = Object.defineProperty, Ct = Object.getOwnPropertyDescriptor, N = (t, e, s, r) => {
...
var kt = Object.defineProperty, Lt = Object.getOwnPropertyDescriptor, he = (t, e, s, r) => {
  for (var i = r > 1 ? void 0 : r ? Lt(e, s) : e, n = t.length - 1, o; n >= 0; n--)
    (o = t[n]) && (i = (r ? o(e, s, i) : o(i)) || i);
  return r && i && kt(e, s, i), i;
};
let j = class extends g {
  static getConfigElement() {
    return Promise.resolve().then(() => Mt), document.createElement("ha-capwatcher-card-editor");
  }
...
var Nt = Object.defineProperty, Ut = Object.getOwnPropertyDescriptor, ue = (t, e, s, r) => {
  for (var i = r > 1 ? void 0 : r ? Ut(e, s) : e, n = t.length - 1, o; n >= 0; n--)
    (o = t[n]) && (i = (r ? o(e, s, i) : o(i)) || i);
